    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = r'C:\Users\M.SHIVA KUMAR\Documents\projects\edunet internship\attendence management system\Attendance\Manually Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\M.SHIVA KUMAR\Documents\projects\edunet internship\attendence management system\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = r'C:\Users\M.SHIVA KUMAR\Documents\projects\edunet internship\attendence management system\Attendance\Manually Attendance' + DB_table_name + '.csv'
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,C:\Users\M.SHIVA KUMAR\Documents\projects\edunet internship\attendence management system\Attendance\-------Check atttendance-------')
    ...
    def log_in():
        ...
        if username == 'shiva':
            if password == 'shiva123':
                ...
                cs =r'C:\Users\M.SHIVA KUMAR\Documents\projects\edunet internship\attendence management system\StudentDetails\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
